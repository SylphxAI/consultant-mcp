/**
 * Sync optionalDependency + platform package versions to @sylphx/consultant-mcp version.
 * Run before publish so platform packages ship at the same version as the main package.
 */
