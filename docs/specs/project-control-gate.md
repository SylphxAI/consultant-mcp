...
3. `src/`, `package.json`, `bun.lock`, and `src/__tests__/` for package/source changes.
...
- run `bun run verify` for typecheck, tests, build, and dry-run npm package verification;
- run `bun run test:project-control`;
