...
describe("Web MCP HTTP ts_deleted gate", () => {
  it("check-no-ts-http-backend gate script enforces Rust HTTP authority", () => {
  ...
  it("npm bin routes HTTP to Rust rmcp without TS fallback", () => {
